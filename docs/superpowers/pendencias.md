...
| Ícone do programa | Não havia arte da MT em `.ico`. A página usa o favicon do site da MT, mas o `.exe` segue com o ícone padrão do Windows | Arquivo `.ico` da marca da MT, usado no `.exe` |
