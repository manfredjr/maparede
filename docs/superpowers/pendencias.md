...
| Página no endereço novo | O nome mudou para MapNet - MT em 25/09/2026, e a página passa para `mapnet.manfred.com.br`. O endereço antigo `maparede.manfred.com.br` precisa redirecionar para o novo | Seguir `docs/publicacao.md`, seções 3 e 4 |
