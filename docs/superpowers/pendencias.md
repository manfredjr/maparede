...
|---|---|---|
| Enquadramento jurídico inicial | Análise feita pela `legal-br` em 26/09/2026, em `docs/legal/verificacao-varredura-e-lgpd-2026-09-26.md`. Ficaram 4 questões para advogado (sondagem de portas e autorização para aparelhos pessoais, distribuição pública, papel da MT na LGPD, relação de consumo e GPL), em `docs/legal/CONSULTA-ADVOGADO-varredura-e-lgpd-2026-09-26.md` | Resposta do advogado. As questões 1 e 2 travam a publicação da 0.3.0 |
