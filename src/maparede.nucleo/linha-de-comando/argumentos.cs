...
public sealed class ArgumentosCli
{
    public const string TextoAjuda = """
        MapaRede - MT: inventário da rede local
        https://maparede.manfred.com.br

        Uso:
          maparede                        abre a janela
          maparede --interfaces           lista as interfaces de rede ativas
          maparede --varrer [opções]      varre a sub-rede e grava o relatório HTML
          maparede --ajuda                mostra esta ajuda
          maparede --versao               mostra a versão
        ...
        Exemplo:
          maparede --varrer --interface Wi-Fi --saida C:\Relatorios --abrir
        """;
