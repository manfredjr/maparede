...
internal sealed class FormularioPrincipal : Form
{
    ...
    {
        Text = $"MapaRede - MT {ResultadoVarredura.VersaoPrograma}";
    ...
    /// <summary>Documentos\MapaRede - MT, onde cada varredura grava o relatório.</summary>
    private static string PastaRelatorios =>
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "MapaRede - MT");
